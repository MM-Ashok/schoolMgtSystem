    ...
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('tprofile') }}" class="bg-gray-700 text-white text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('teacherprofile.update') }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                @csrf
                @method('PUT')
